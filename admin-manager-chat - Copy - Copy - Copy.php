  ...
  <div class="container-fluid">
    ...
    <section class="chat-area">
      <header>
        ...
        <a href="admin-page.php" class="back-icon"><ion-icon class="btn btn-outline-warning" name="arrow-back"></ion-icon></a>
        ...
        <div class="details">
          ...
          <li class="mt-3"><a href="admin-manager-profile.php?user_id=<?php echo $user_id; ?>" class="btn btn-outline-warning" style="text-decoration:none; margin-left: 30px"><b class="text-light">Check Profile</b></a></li>
          </form>
          </ul>
          </div>
      ...
      <div class="chat-box">
       ...
       <form method="post" id="messageFrom" class="typing-area">
        ...
        <input type="text" name="message" class="input-field" placeholder="Type a message here..." autocomplete="off">
         <button type="submit" name="send_msg" value="" class="button btn btn-outline-warning"><ion-icon name="send"></ion-icon></button>
      </form>
      </div>
    </div>
  </div>
