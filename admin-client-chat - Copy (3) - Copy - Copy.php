    ...
    <section class="chat-area">
      <header>
        ...
        <div class="details">
          ...
          <li class="mt-3"><a href="admin-client-profile.php?user_id=<?php echo $user_id; ?>" class="btn btn-outline-warning" style="text-decoration:none; margin-left: 30px"><b class="text-light">Check Profile</b></a></li>
          </form>
          </ul>
          </div>
