            ...
            <div class="col-md-6">
                <form method="post">
                    ...
                    <div class="msg mt-5" style="position: relative; margin-left: 200px;">
                        ...
                        <p class=" mt-3" style="margin-left: 255px; font-size: 18px;"><b>Client </b> <b style="color: rgb(6, 151, 79);">Login</b> <b> / </b><a href="client-register.php" class="regi text-dark" style="text-decoration: none; font-size: 18px;"><b>Register</b></a></p>
                        ...
                        <div class="input mt-5" style="margin-left: 220px;">
                            ...
                            <div class="pass mt-5">
                                ...
                                <a href="forgot-password.php" class="text-dark" style="text-decoration: none; margin-left: 155px; font-size: 13px;"><b>Forget Password</b></a>
                            </div>
